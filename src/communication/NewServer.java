...
public class NewServer extends JFrame {
	...
	public NewServer(){
		...
		setSize(600, 350); //Sets the window size
		setVisible(false);
	}
	
	public void startRunning(){
		try{
			server = new ServerSocket(8081, 100); //6789 is a dummy port for testing, this can be changed. The 100 is the maximum people waiting to connect.
			while(true){
				try{
