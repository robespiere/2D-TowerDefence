...
public class Enemy implements Entity {
	...
	public Enemy(int tileX, int tileY, TileGrid grid) {
		this.healthBackground = LoadTexture("res/" + "healthBackground" + ".png", "PNG");
		this.healthForeground = LoadTexture("res/" + "healthForeground" + ".png", "PNG");
		this.healthBorder = LoadTexture("res/" + "healthBorder" + ".png", "PNG");
	...
	public void damage(int amount) {
		...
		if (health <= 0) {
			die();
			Player.modifyScore((int) (healthCheck / 5) * Player.Lives );
			Player.modifyCrystal(5);
		}
	}
	...
	public void setTexture(String textureName) {
		this.texture = LoadTexture("res/" + textureName + ".png", "PNG");
	}
	
	public void setTextureGif(String textureName) {
		this.texture = LoadTexture("res/" + textureName + ".gif", "GIF");
	}
