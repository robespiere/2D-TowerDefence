		...
		for (int i = 0; i < map.length; i++) {
			for (int j = 0; j < map[i].length; j++) {
				...
				case 2:
					...
					break;
				case 3: 
					map[i][j] = new Tile(i * TILE_SIZE, j * TILE_SIZE, TILE_SIZE, TILE_SIZE, TileType.Grass2);
					break;
				case 4:
					map[i][j] = new Tile(i * TILE_SIZE, j * TILE_SIZE, TILE_SIZE, TILE_SIZE, TileType.Dirt2);
					break;
				case 5:
					map[i][j] = new Tile(i * TILE_SIZE, j * TILE_SIZE, TILE_SIZE, TILE_SIZE, TileType.Water2);
					break;
				}
			}
		}
